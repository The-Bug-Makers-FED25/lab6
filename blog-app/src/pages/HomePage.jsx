...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-fit flex flex-col items-center px-4
                     ${light ? "bg-grey text-black" : "bg-darkbg text-white"}`}>

        <div className={"flex flex-row items-center h-[79vh] justify-center gap-40"}>
        ...
        <div className={"flex flex-row items-center justify-center h-[90vh] gap-40 mb-8"}>
